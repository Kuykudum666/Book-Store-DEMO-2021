<header class="bg-dark py-5" style="background-image: url('icon/backimg3.gif');">
        ...
        <section class="py-5">
            <div class="h1gu">
            <h1 style="font-family: 'Kanit', sans-serif;">หนังสือมาใหม่</h1>
            </div>
                 <div class="best-seller">
                    <?php 
                    require_once('database/condb.php');
                    $sql = "SELECT * FROM tbl_book inner join tbl_user on tbl_book.u_id = tbl_user.u_id inner join tbl_category on tbl_book.c_id = tbl_category.c_id AND tbl_book.status_book = '1'";
