          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <?php
                ...
                $sql = "SELECT * FROM tbl_book inner join tbl_user on tbl_book.u_id = tbl_user.u_id inner join tbl_category on tbl_book.c_id = tbl_category.c_id WHERE tbl_user.u_id = '".$_SESSION['u_id']."'";
                ...
                ?>
                  <tr>
                      ...
                      <td class="text-center">
                          <a href="index.php?book_edit=<?= $row['bookid']; ?>" class="btn btn-info btn-sm"><i class="mdi mdi-grease-pencil"></i></a>
