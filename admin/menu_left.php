...
?>
    ...
    <li class="nav-item menu-items">
      <a href="index.php?main" class="nav-link <?=$main;?>" >
        <span class="menu-icon">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link <?=$admin;?>" href="index.php?admin">
        <span class="menu-icon">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link <?=$user;?>" href="index.php?user">
        <span class="menu-icon">
          <i class="mdi mdi-account-multiple"></i>
        </span>
    ...
    <li class="nav-item menu-items">
      <a class="nav-link <?=$book;?>" href="index.php?book">
        <span class="menu-icon">
          <i class="mdi mdi-book-open"></i>
        </span>
    ...
    <li class="nav-item menu-items">
      <a class="nav-link <?=$approve;?>" href="index.php?approve">
        <span class="menu-icon">
    ...
    <li class="nav-item menu-items">
      <a class="nav-link <?=$booktype;?>" href="index.php?book_type">
        <span class="menu-icon">
