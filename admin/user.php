          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="co-6 text-right">
                  <div class="col-6">
                  <h3 class="card-title">แสดงรายชื่อสมาชิก</h3>
                  </div>

                  
              <div>
                <h3 class="card-title"></h3>
                <a href="index.php?user_add" class="btn btn-success"><i class ="fas fa--plus"></i> เพิ่มสมาชิก</a>
              ...
              <tbody>
                ...
                require_once('../database/condb.php');
                    $sql = "SELECT * FROM tbl_user WHERE status = '0' ORDER BY fullname ASC ";
                ...
                ?>
                  <tr>
                      ...
                      <td class="text-center">
                          ...
                          <a href="index.php?user_del=<?= $row['u_id']; ?>" onclick="return confirm('ยืนยันการลบ')"class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i></a>
                      </td>
                  </tr>
                <?php
                    }
