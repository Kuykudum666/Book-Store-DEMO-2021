<header class="bg-dark py-5" style="background-image: url('icon/bookimg.png');">
            <div class="container px-4 px-lg-5 my-5">
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">Psychology</h1>
        ...
        <section class="py-5">
            ...
            <div class="h1gu">
            <h1 style="font-family: 'Kanit', sans-serif;">หนังสือจิตวิทยาทั่วไป</h1>
            </div>
                 <div class="best-seller">
                    <?php 
                    require_once('database/condb.php');
                    $sql = "SELECT * FROM tbl_book inner join tbl_user on tbl_book.u_id = tbl_user.u_id inner join tbl_category on tbl_book.c_id = tbl_category.c_id AND tbl_book.status_book = '1' WHERE tbl_book.c_id = '4'";
