<?php
  // ส่งข้อมูลไป data base enter data to database
        if(isset($_POST['btn_save'])){
            ...
            if(mysqli_num_rows($select)) {
              ...
              echo "<meta http-equiv=\"refresh\" content=\"0; URL=index.php?admin_add\">";
              exit;
            }
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">ฟอร์มเพิ่มข้อมูลผู้ดูแลระบบ</small></h3>
              </div>
